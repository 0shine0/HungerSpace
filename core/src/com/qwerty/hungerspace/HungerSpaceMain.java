...
import com.qwerty.hungerspace.screens.LoadingScreen;
...
public class HungerSpaceMain extends ApplicationAdapter {
	...
	public void create () {
		...
		assetManager.load("texture/loadingAtlas.atlas", TextureAtlas.class);
		...
		assetHolder.loadingAtlas = assetManager.get("texture/loadingAtlas.atlas", TextureAtlas.class);

		loadingScreen = new LoadingScreen(this);

		screensManager.pushScreen(loadingScreen);
	}
